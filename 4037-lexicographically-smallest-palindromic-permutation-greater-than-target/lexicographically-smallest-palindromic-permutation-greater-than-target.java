class Solution {
    private boolean rec(char[] half, int idx, int[] cnt, String target, boolean isGreater, char oddch, int n) {
        ...
        for(int i = 0; i < 26; i++) {
            ...
            if(cnt[i] > 0) {
                ...
                if(rec(half, idx+1, cnt, target, nextGreater, oddch, n)) {
    ...
    public String lexPalindromicPermutation(String s, String target) {
        ...
        if(!rec(half, 0, halfcnt, target, false, oddch, n)) {
